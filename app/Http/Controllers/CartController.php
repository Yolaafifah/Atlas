...
class CartController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        $get_from_cart = Helper::getAllProductFromCart();
        $product = Product::findOrFail($get_from_cart[0]->product_id);

        $total_weight =  $product->actual_size_in_kg * $get_from_cart[0]->quantity;

        return view('frontend.pages.checkout')->with('total_weight', $total_weight);
    }
}
