                        ...
                        <!-- <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Track Order</a></li> -->
                            ...
                            @auth
                                @if(Auth::user()->role=='admin')
                                    <li><i class="ti-user"></i> <a href="{{url('/admin/order')}}"  target="_blank">Dashboard</a></li>
                                @else
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">Masuk /</a> <a href="{{route('register.form')}}">Registrasi</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Cari Product Disini....." type="search">
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('contact')}}">Kontak Kami</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
