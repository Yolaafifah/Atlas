...
@section('title','PT. Jatim Es Tube - Gresik || HOME PAGE')
    ...
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item {{(($key==0)? 'active' : '')}}">
                    <img class="first-slide" src="{{ url($banner->photo) }}" alt="First slide">
                    <div class="carousel-caption d-none d-md-block text-left">
                        <h2 class="wow fadeInDown">{{$banner->title}}</h2>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                @if($product->stock >0)
                                                <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} Stok ada</span>
                                                @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} Habis</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
