          ...
          <tbody>
            ...
            @foreach($transportations as $transportation)   
                <tr>
                    ...
                    <td>Rp. {{$transportation->categori_trans}}</td>
                    <td>
                        @if($transportation->status=='active')
                            <span class="badge badge-success">{{$transportation->status}}</span>
                        @else
                            <span class="badge badge-warning">{{$transportation->status}}</span>
                        @endif
                    </td>
                    <td>
                      @if($transportation->capacity>0)
                      <span class="badge badge-primary">{{$$transportation->capacity}}</span>
                      @else
                      <span class="badge badge-danger">{{$$transportation->capacity}}</span>
                      @endif
                    </td>
                    <td>
